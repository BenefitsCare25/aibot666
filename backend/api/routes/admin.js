...
(function() {
  ...
  window.addEventListener('message', function(event) {
    if (event.data && event.data.type === 'chatWidgetResize') {
      ...
      // Full screen when open, corner position when closed
 ...
 */
router.get('/analytics/frequent-categories', async (req, res) => {
  try {
 ...
 */
router.get('/analytics/query-trends', async (req, res) => {
  try {
