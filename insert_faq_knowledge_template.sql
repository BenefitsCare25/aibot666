-- FAQ Knowledge Base Insert Statements (TEMPLATE)
-- Generated from Helpdesk FAQ for Chatbot.xlsx
-- Total Questions: 26 (1 skipped due to empty answer)
--
-- USAGE INSTRUCTIONS:
-- 1. Replace ALL occurrences of {{SCHEMA_NAME}} with your actual schema name
--    Examples: company_a, company_b, your_company_schema
-- 2. Run this in Supabase SQL Editor
-- 3. Verify with the summary query at the bottom

-- OPTIONAL: Clear existing FAQ data first (uncomment if needed)
-- DELETE FROM {{SCHEMA_NAME}}.knowledge_base WHERE source = 'Helpdesk FAQ Excel';

-- Benefit Coverage (15 questions)

INSERT INTO {{SCHEMA_NAME}}.knowledge_base (title, content, category, subcategory, metadata, source, confidence_score, is_active)
VALUES (
...
-- Summary query to verify inserts (replace {{SCHEMA_NAME}} before running)
SELECT
  category,
  subcategory,
