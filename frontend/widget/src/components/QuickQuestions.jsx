...
export default function QuickQuestions({ onQuestionSelect, primaryColor }) {
  ...
  if (loading) {
    return (
      <div className="ic-flex-1 ic-overflow-y-auto ic-p-4 ic-bg-white">
  ...
  return (
    <div className="ic-flex-1 ic-overflow-y-auto ic-p-4 ic-space-y-3 ic-bg-white">
      <div className="ic-text-center ic-mb-4">
        <div className="ic-w-14 ic-h-14 ic-bg-red-50 ic-rounded-full ic-flex ic-items-center ic-justify-center ic-mx-auto ic-mb-3 ic-shadow-sm">
      ...
      {quickQuestions.map((category) => (
        <div key={category.id} className="ic-bg-white ic-rounded-lg ic-shadow-sm ic-overflow-hidden ic-border ic-border-gray-200 ic-transition-all">
          ...
          {expandedCategory === category.id && (
            <div className="ic-border-t ic-border-gray-200 ic-bg-gray-50 ic-animate-fade-in ic-p-3 ic-space-y-2">
